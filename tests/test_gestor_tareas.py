...
class TestGestorTareas(unittest.TestCase):
    ...
    def test_marcar_completada_tarea_no_encontrada(self):
        with self.assertRaises(ValueError):
            self.gestor.marcar_completada("Tarea Inexistente")
    ...
    def test_eliminar_tarea_no_encontrada(self):
        with self.assertRaises(ValueError):
            self.gestor.eliminar_tarea("Tarea Inexistente")
